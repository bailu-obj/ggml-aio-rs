...
impl ParamOverrideValue {
    pub(crate) fn tag(&self) -> ggml_aio_sys::llama_model_kv_override_type {
        match self {
            ParamOverrideValue::Bool(_) => ggml_aio_sys::LLAMA_KV_OVERRIDE_TYPE_BOOL,
            ParamOverrideValue::Float(_) => ggml_aio_sys::LLAMA_KV_OVERRIDE_TYPE_FLOAT,
            ParamOverrideValue::Int(_) => ggml_aio_sys::LLAMA_KV_OVERRIDE_TYPE_INT,
            ParamOverrideValue::Str(_) => ggml_aio_sys::LLAMA_KV_OVERRIDE_TYPE_STR,
        }
    }

    pub(crate) fn value(&self) -> ggml_aio_sys::llama_model_kv_override__bindgen_ty_1 {
        match self {
            ParamOverrideValue::Bool(value) => {
                ggml_aio_sys::llama_model_kv_override__bindgen_ty_1 { val_bool: *value }
            }
            ParamOverrideValue::Float(value) => {
                ggml_aio_sys::llama_model_kv_override__bindgen_ty_1 { val_f64: *value }
            }
            ParamOverrideValue::Int(value) => {
                ggml_aio_sys::llama_model_kv_override__bindgen_ty_1 { val_i64: *value }
            }
            ParamOverrideValue::Str(c_string) => {
                ggml_aio_sys::llama_model_kv_override__bindgen_ty_1 { val_str: *c_string }
            }
        }
    }
}

impl From<&ggml_aio_sys::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        ggml_aio_sys::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &ggml_aio_sys::llama_model_kv_override,
