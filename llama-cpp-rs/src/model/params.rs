...
const LLAMA_SPLIT_MODE_NONE: i8 = ggml_aio_sys::LLAMA_SPLIT_MODE_NONE as i8;
#[allow(clippy::cast_possible_wrap)]
#[allow(clippy::cast_possible_truncation)]
const LLAMA_SPLIT_MODE_LAYER: i8 = ggml_aio_sys::LLAMA_SPLIT_MODE_LAYER as i8;
#[allow(clippy::cast_possible_wrap)]
#[allow(clippy::cast_possible_truncation)]
const LLAMA_SPLIT_MODE_ROW: i8 = ggml_aio_sys::LLAMA_SPLIT_MODE_ROW as i8;
...
pub struct LlamaModelParams {
    pub(crate) params: ggml_aio_sys::llama_model_params,
    kv_overrides: Vec<ggml_aio_sys::llama_model_kv_override>,
    buft_overrides: Vec<ggml_aio_sys::llama_model_tensor_buft_override>,
    devices: Pin<Box<[ggml_aio_sys::ggml_backend_dev_t; LLAMA_CPP_MAX_DEVICES]>>,
}
...
impl LlamaModelParams {
    ...
    pub fn append_kv_override(
        ...
        self.kv_overrides
            .push(ggml_aio_sys::llama_model_kv_override {
                key: [0; 128],
                tag: 0,
                __bindgen_anon_1: ggml_aio_sys::llama_model_kv_override__bindgen_ty_1 {
                    val_i64: 0,
                },
            });
...
impl LlamaModelParams {
    ...
    pub fn add_cpu_buft_override(mut self: Pin<&mut Self>, key: &CStr) {
        ...
        buft_override.buft = unsafe { ggml_aio_sys::ggml_backend_cpu_buffer_type() };
        ...
        // push the next one to ensure we maintain the iterator invariant of ending with a 0
        self.buft_overrides
            .push(ggml_aio_sys::llama_model_tensor_buft_override {
...
impl LlamaModelParams {
    ...
    pub fn devices(&self) -> Vec<usize> {
        ...
        for i in 0..unsafe { ggml_aio_sys::ggml_backend_dev_count() } {
    ...
    pub fn with_devices(mut self, devices: &[usize]) -> Result<Self, LlamaCppError> {
        ...
        for (i, &dev) in devices.iter().enumerate() {
            if dev >= unsafe { ggml_aio_sys::ggml_backend_dev_count() } {
                return Err(LlamaCppError::BackendDeviceNotFound(dev));
            }
            let backend_dev = unsafe { ggml_aio_sys::ggml_backend_dev_get(dev) };
...
impl Default for LlamaModelParams {
    fn default() -> Self {
        let default_params = unsafe { ggml_aio_sys::llama_model_default_params() };
        LlamaModelParams {
