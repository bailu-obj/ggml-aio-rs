...
pub enum KvCacheType {
    ...
    Unknown(ggml_aio_sys::ggml_type),
    F32,
    F16,
    Q4_0,
    Q4_1,
...
impl From<KvCacheType> for ggml_aio_sys::ggml_type {
    fn from(value: KvCacheType) -> Self {
        match value {
            KvCacheType::Unknown(raw) => raw,
            KvCacheType::F32 => ggml_aio_sys::GGML_TYPE_F32,
            KvCacheType::F16 => ggml_aio_sys::GGML_TYPE_F16,
            KvCacheType::Q4_0 => ggml_aio_sys::GGML_TYPE_Q4_0,
            KvCacheType::Q4_1 => ggml_aio_sys::GGML_TYPE_Q4_1,
            KvCacheType::Q5_0 => ggml_aio_sys::GGML_TYPE_Q5_0,
            KvCacheType::Q5_1 => ggml_aio_sys::GGML_TYPE_Q5_1,
            KvCacheType::Q8_0 => ggml_aio_sys::GGML_TYPE_Q8_0,
            KvCacheType::Q8_1 => ggml_aio_sys::GGML_TYPE_Q8_1,
            KvCacheType::Q2_K => ggml_aio_sys::GGML_TYPE_Q2_K,
            KvCacheType::Q3_K => ggml_aio_sys::GGML_TYPE_Q3_K,
            KvCacheType::Q4_K => ggml_aio_sys::GGML_TYPE_Q4_K,
            KvCacheType::Q5_K => ggml_aio_sys::GGML_TYPE_Q5_K,
            KvCacheType::Q6_K => ggml_aio_sys::GGML_TYPE_Q6_K,
            KvCacheType::Q8_K => ggml_aio_sys::GGML_TYPE_Q8_K,
            KvCacheType::IQ2_XXS => ggml_aio_sys::GGML_TYPE_IQ2_XXS,
            KvCacheType::IQ2_XS => ggml_aio_sys::GGML_TYPE_IQ2_XS,
            KvCacheType::IQ3_XXS => ggml_aio_sys::GGML_TYPE_IQ3_XXS,
            KvCacheType::IQ1_S => ggml_aio_sys::GGML_TYPE_IQ1_S,
            KvCacheType::IQ4_NL => ggml_aio_sys::GGML_TYPE_IQ4_NL,
            KvCacheType::IQ3_S => ggml_aio_sys::GGML_TYPE_IQ3_S,
            KvCacheType::IQ2_S => ggml_aio_sys::GGML_TYPE_IQ2_S,
            KvCacheType::IQ4_XS => ggml_aio_sys::GGML_TYPE_IQ4_XS,
            KvCacheType::I8 => ggml_aio_sys::GGML_TYPE_I8,
            KvCacheType::I16 => ggml_aio_sys::GGML_TYPE_I16,
            KvCacheType::I32 => ggml_aio_sys::GGML_TYPE_I32,
            KvCacheType::I64 => ggml_aio_sys::GGML_TYPE_I64,
            KvCacheType::F64 => ggml_aio_sys::GGML_TYPE_F64,
            KvCacheType::IQ1_M => ggml_aio_sys::GGML_TYPE_IQ1_M,
            KvCacheType::BF16 => ggml_aio_sys::GGML_TYPE_BF16,
            KvCacheType::TQ1_0 => ggml_aio_sys::GGML_TYPE_TQ1_0,
            KvCacheType::TQ2_0 => ggml_aio_sys::GGML_TYPE_TQ2_0,
            KvCacheType::MXFP4 => ggml_aio_sys::GGML_TYPE_MXFP4,
        }
    }
}

impl From<ggml_aio_sys::ggml_type> for KvCacheType {
    fn from(value: ggml_aio_sys::ggml_type) -> Self {
        match value {
            x if x == ggml_aio_sys::GGML_TYPE_F32 => KvCacheType::F32,
            x if x == ggml_aio_sys::GGML_TYPE_F16 => KvCacheType::F16,
            x if x == ggml_aio_sys::GGML_TYPE_Q4_0 => KvCacheType::Q4_0,
            x if x == ggml_aio_sys::GGML_TYPE_Q4_1 => KvCacheType::Q4_1,
            x if x == ggml_aio_sys::GGML_TYPE_Q5_0 => KvCacheType::Q5_0,
            x if x == ggml_aio_sys::GGML_TYPE_Q5_1 => KvCacheType::Q5_1,
            x if x == ggml_aio_sys::GGML_TYPE_Q8_0 => KvCacheType::Q8_0,
            x if x == ggml_aio_sys::GGML_TYPE_Q8_1 => KvCacheType::Q8_1,
            x if x == ggml_aio_sys::GGML_TYPE_Q2_K => KvCacheType::Q2_K,
            x if x == ggml_aio_sys::GGML_TYPE_Q3_K => KvCacheType::Q3_K,
            x if x == ggml_aio_sys::GGML_TYPE_Q4_K => KvCacheType::Q4_K,
            x if x == ggml_aio_sys::GGML_TYPE_Q5_K => KvCacheType::Q5_K,
            x if x == ggml_aio_sys::GGML_TYPE_Q6_K => KvCacheType::Q6_K,
            x if x == ggml_aio_sys::GGML_TYPE_Q8_K => KvCacheType::Q8_K,
            x if x == ggml_aio_sys::GGML_TYPE_IQ2_XXS => KvCacheType::IQ2_XXS,
            x if x == ggml_aio_sys::GGML_TYPE_IQ2_XS => KvCacheType::IQ2_XS,
            x if x == ggml_aio_sys::GGML_TYPE_IQ3_XXS => KvCacheType::IQ3_XXS,
            x if x == ggml_aio_sys::GGML_TYPE_IQ1_S => KvCacheType::IQ1_S,
            x if x == ggml_aio_sys::GGML_TYPE_IQ4_NL => KvCacheType::IQ4_NL,
            x if x == ggml_aio_sys::GGML_TYPE_IQ3_S => KvCacheType::IQ3_S,
            x if x == ggml_aio_sys::GGML_TYPE_IQ2_S => KvCacheType::IQ2_S,
            x if x == ggml_aio_sys::GGML_TYPE_IQ4_XS => KvCacheType::IQ4_XS,
            x if x == ggml_aio_sys::GGML_TYPE_I8 => KvCacheType::I8,
            x if x == ggml_aio_sys::GGML_TYPE_I16 => KvCacheType::I16,
            x if x == ggml_aio_sys::GGML_TYPE_I32 => KvCacheType::I32,
            x if x == ggml_aio_sys::GGML_TYPE_I64 => KvCacheType::I64,
            x if x == ggml_aio_sys::GGML_TYPE_F64 => KvCacheType::F64,
            x if x == ggml_aio_sys::GGML_TYPE_IQ1_M => KvCacheType::IQ1_M,
            x if x == ggml_aio_sys::GGML_TYPE_BF16 => KvCacheType::BF16,
            x if x == ggml_aio_sys::GGML_TYPE_TQ1_0 => KvCacheType::TQ1_0,
            x if x == ggml_aio_sys::GGML_TYPE_TQ2_0 => KvCacheType::TQ2_0,
            x if x == ggml_aio_sys::GGML_TYPE_MXFP4 => KvCacheType::MXFP4,
...
pub struct LlamaContextParams {
    pub(crate) context_params: ggml_aio_sys::llama_context_params,
}
...
impl LlamaContextParams {
    ...
    pub fn with_flash_attention_policy(
        mut self,
        policy: ggml_aio_sys::llama_flash_attn_type,
    ) -> Self {
    ...
    #[must_use]
    pub fn flash_attention_policy(&self) -> ggml_aio_sys::llama_flash_attn_type {
...
impl Default for LlamaContextParams {
    fn default() -> Self {
        let context_params = unsafe { ggml_aio_sys::llama_context_default_params() };
        Self { context_params }
    }
}
