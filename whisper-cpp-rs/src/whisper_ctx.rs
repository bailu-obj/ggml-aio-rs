...
pub struct WhisperInnerContext {
    pub(crate) ctx: *mut ggml_aio_sys::whisper_context,
}
...
impl WhisperInnerContext {
    ...
    pub fn n_vocab(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_n_vocab(self.ctx) }
    }
    ...
    pub fn n_text_ctx(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_n_text_ctx(self.ctx) }
    }
    ...
    pub fn n_audio_ctx(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_n_audio_ctx(self.ctx) }
    }
    ...
    pub fn is_multilingual(&self) -> bool {
        unsafe { ggml_aio_sys::whisper_is_multilingual(self.ctx) != 0 }
    }
    ...
    pub fn model_n_vocab(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_vocab(self.ctx) }
    }
    ...
    pub fn model_n_audio_ctx(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_audio_ctx(self.ctx) }
    }
    ...
    pub fn model_n_audio_state(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_audio_state(self.ctx) }
    }
    ...
    pub fn model_n_audio_head(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_audio_head(self.ctx) }
    }
    ...
    pub fn model_n_audio_layer(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_audio_layer(self.ctx) }
    }
    ...
    pub fn model_n_text_ctx(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_text_ctx(self.ctx) }
    }
    ...
    pub fn model_n_text_state(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_text_state(self.ctx) }
    }
    ...
    pub fn model_n_text_head(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_text_head(self.ctx) }
    }
    ...
    pub fn model_n_text_layer(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_text_layer(self.ctx) }
    }
    ...
    pub fn model_n_mels(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_n_mels(self.ctx) }
    }
    ...
    pub fn model_ftype(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_ftype(self.ctx) }
    }
    ...
    pub fn model_type(&self) -> c_int {
        unsafe { ggml_aio_sys::whisper_model_type(self.ctx) }
    }
    ...
    pub fn token_to_cstr(&self, token_id: WhisperToken) -> Result<&CStr, WhisperError> {
        let ret = unsafe { ggml_aio_sys::whisper_token_to_str(self.ctx, token_id) };
        if ret.is_null() {
    ...
    pub fn model_type_readable(&self) -> Result<String, WhisperError> {
        let ret = unsafe { ggml_aio_sys::whisper_model_type_readable(self.ctx) };
        if ret.is_null() {
            return Err(WhisperError::NullPointer);
        }
    ...
    pub fn token_eot(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_eot(self.ctx) }
    }
    ...
    pub fn token_sot(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_sot(self.ctx) }
    }
    ...
    pub fn token_solm(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_solm(self.ctx) }
    }
    ...
    pub fn token_prev(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_prev(self.ctx) }
    }
    ...
    pub fn token_nosp(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_nosp(self.ctx) }
    }
    ...
    pub fn token_not(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_not(self.ctx) }
    }
    ...
    pub fn token_beg(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_beg(self.ctx) }
    }
    ...
    pub fn token_lang(&self, lang_id: c_int) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_lang(self.ctx, lang_id) }
    }
    ...
    pub fn print_timings(&self) {
        unsafe { ggml_aio_sys::whisper_print_timings(self.ctx) }
    }
    ...
    pub fn reset_timings(&self) {
        unsafe { ggml_aio_sys::whisper_reset_timings(self.ctx) }
    }
    ...
    pub fn token_translate(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_translate(self.ctx) }
    }
    ...
    pub fn token_transcribe(&self) -> WhisperToken {
        unsafe { ggml_aio_sys::whisper_token_transcribe(self.ctx) }
    }
}
...
impl Drop for WhisperInnerContext {
    #[inline]
    fn drop(&mut self) {
        unsafe { ggml_aio_sys::whisper_free(self.ctx) };
    }
}
...
impl<'a> WhisperContextParameters<'a> {
    ...
    fn to_c_struct(&self) -> ggml_aio_sys::whisper_context_params {
        ...
        let mut dtw_aheads = ggml_aio_sys::whisper_aheads {
            n_heads: 0,
            heads: std::ptr::null(),
        };
        ...
        match &self.dtw_parameters.mode {
            ...
            DtwMode::TopMost { n_top } => {
                dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_N_TOP_MOST;
                dtw_n_top = *n_top;
            }
            DtwMode::Custom { aheads } => {
                dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_CUSTOM;

                dtw_aheads = ggml_aio_sys::whisper_aheads {
                    n_heads: aheads.len(),
                    heads: aheads.as_ptr(),
                };
            }
            DtwMode::ModelPreset { model_preset } => match model_preset {
                DtwModelPreset::TinyEn => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_TINY_EN;
                }
                DtwModelPreset::Tiny => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_TINY;
                }
                DtwModelPreset::BaseEn => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_BASE_EN;
                }
                DtwModelPreset::Base => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_BASE;
                }
                DtwModelPreset::SmallEn => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_SMALL_EN;
                }
                DtwModelPreset::Small => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_SMALL;
                }
                DtwModelPreset::MediumEn => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_MEDIUM_EN;
                }
                DtwModelPreset::Medium => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_MEDIUM;
                }
                DtwModelPreset::LargeV1 => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_LARGE_V1;
                }
                DtwModelPreset::LargeV2 => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_LARGE_V2;
                }
                DtwModelPreset::LargeV3 => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_LARGE_V3;
                }
                DtwModelPreset::LargeV3Turbo => {
                    dtw_aheads_preset = ggml_aio_sys::WHISPER_AHEADS_LARGE_V3_TURBO;
                }
            },
        }

        ggml_aio_sys::whisper_context_params {
...
pub enum DtwMode<'a> {
    ...
    Custom {
        aheads: &'a [ggml_aio_sys::whisper_ahead],
    },
