use ggml_aio_sys::{
    WHISPER_GRETYPE_ALT, WHISPER_GRETYPE_CHAR, WHISPER_GRETYPE_CHAR_ALT, WHISPER_GRETYPE_CHAR_NOT,
...
impl From<ggml_aio_sys::whisper_gretype> for WhisperGrammarElementType {
    fn from(value: ggml_aio_sys::whisper_gretype) -> Self {
        assert!(
            (0..=6).contains(&value),
        ...
        match value {
            ...
            WHISPER_GRETYPE_CHAR_RNG_UPPER => WhisperGrammarElementType::CharacterRangeUpper,
            WHISPER_GRETYPE_CHAR_ALT => WhisperGrammarElementType::CharacterAlternate,
            _ => unreachable!(),
        }
    }
}

impl From<WhisperGrammarElementType> for ggml_aio_sys::whisper_gretype {
...
impl WhisperGrammarElement {
    ...
    pub fn to_c_type(self) -> ggml_aio_sys::whisper_grammar_element {
        ggml_aio_sys::whisper_grammar_element {
