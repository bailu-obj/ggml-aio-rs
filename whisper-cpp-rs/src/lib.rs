...
pub type WhisperSysState = ggml_aio_sys::whisper_state;

pub type WhisperTokenData = ggml_aio_sys::whisper_token_data;
pub type WhisperToken = ggml_aio_sys::whisper_token;
pub type WhisperNewSegmentCallback = ggml_aio_sys::whisper_new_segment_callback;
pub type WhisperStartEncoderCallback = ggml_aio_sys::whisper_encoder_begin_callback;
pub type WhisperProgressCallback = ggml_aio_sys::whisper_progress_callback;
pub type WhisperLogitsFilterCallback = ggml_aio_sys::whisper_logits_filter_callback;
pub type WhisperAbortCallback = ggml_aio_sys::ggml_abort_callback;
pub type WhisperLogCallback = ggml_aio_sys::ggml_log_callback;
pub type DtwAhead = ggml_aio_sys::whisper_ahead;
