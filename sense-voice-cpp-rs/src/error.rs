...
pub enum SenseVoiceError {
    ...
    InvalidThreadCount,
    /// Invalid UTF-8 detected in a string from SenseVoice.
    InvalidUtf8 {
    ...
    /// SenseVoice returned a null pointer.
    NullPointer,
    /// Generic whisper error. Varies depending on the function.
    GenericError(c_int),
    /// SenseVoice failed to convert the provided text into tokens.
    InvalidText,
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        ...
        match self {
            ...
            InvalidUtf8 {
                ...
                f,
                "Invalid UTF-8 detected in a string from SenseVoice. Index: {}, Length: {}.",
                valid_up_to, len
            ),
            InvalidUtf8 {
                valid_up_to,
                ...
                f,
                "Invalid UTF-8 detected in a string from SenseVoice. Index: {}.",
                valid_up_to
            ),
            ...
            NullPointer => write!(f, "SenseVoice returned a null pointer."),
            InvalidText => write!(
                f,
                "SenseVoice failed to convert the provided text into tokens."
            ),
